<template>
  <v-container class="projects" style="max-width: 100%">
    <div class="mt-5">
      <p class="display-3 text-center font-weight-medium deep-purple--text"> Projects </p>
      <p class="display-1 text-center gray--text"> Check it out </p>
    </div>
    <v-row>
      <v-col cols="12">
        <v-row align="center" justify="center">
          <v-card v-for="project in projects" :key="project.name" width="300px" class="ma-3">
            <div
            ...
            <v-card-text class="text--primary" style="height: 115px" v-text="project.description"></v-card-text>
            <v-card-actions>
...
export default {
  ...
  data() {
    return {
      projects: [
        {
          name: 'WiscEnroll Mobile',
          color1: '#9b0000',
          color2: '#9b0000',
          show: false,
          img_small: false,
          img: 'mdi-school-outline',
          no_url: true,
        ...
        },
        {
          ...
          description: 'While in high school, I developed and release this as my first app on the App Store. Source code is private.', 
          skills: [
            { title: 'Swift', category: 'lang' },
            { title: 'UIKit', category: 'tool' },
            { title: '10,000+ units', category: 'acomplisment' },
        ...
        },
        {
          ...
          show: false,
          img_small: true,
          img: 'mdi-face-recognition',
          no_url: false,
          url: 'https://github.com/stsievert/next-face-demo',
          subtitle: 'Predict Emotion Based on Face Image',
          ...
          skills: [
            ...
            { title: 'Jupyter', category: 'dev' },
            { title: 'SciKitLearn', category: 'tool' },
            { title: 'Web', category: 'platform' },
            { title: 'AI', category: 'tool' }
          ]
        },
        {
          name: 'JoeHolt.dev',
        ...
        {
          name: 'Spartan - Inventory Tracker',
          color1: '#3d5afe',
          color2: '#3d5afe',
          show: false,
          img_small: true,
